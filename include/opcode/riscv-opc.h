...
#define MATCH_VCONFIG 0x57
#define MASK_VCONFIG  0x707f
#define MATCH_VSETVL 0x1057
#define MASK_VSETVL  0x707f
#define MATCH_VADD 0x5f
#define MASK_VADD  0x707f
#define MATCH_VSUB 0x105f
#define MASK_VSUB  0x707f
#define MATCH_VMUL 0x205f
#define MASK_VMUL  0x707f
#define MATCH_VCLIPH 0x305f
#define MASK_VCLIPH  0x707f
#define MATCH_VAND 0x405f
#define MASK_VAND  0x707f
#define MATCH_VOR 0x505f
#define MASK_VOR  0x707f
#define MATCH_VNOT 0x605f
#define MASK_VNOT  0x707f
#define MATCH_VSEQ 0x1067
#define MASK_VSEQ  0x707f
#define MATCH_VSNEQ 0x2067
#define MASK_VSNEQ  0x707f
#define MATCH_VSLT 0x3067
#define MASK_VSLT  0x707f
#define MATCH_VSLE 0x4067
#define MASK_VSLE  0x707f
#define MATCH_VSGT 0x5067
#define MASK_VSGT  0x707f
#define MATCH_VSGE 0x6067
#define MASK_VSGE  0x707f
#define MATCH_VMOVE 0x1047
#define MASK_VMOVE  0x707f
#define MATCH_VPERMUTE 0x2047
#define MASK_VPERMUTE  0x707f
#define MATCH_VREDSUM 0x3047
#define MASK_VREDSUM  0x707f
#define MATCH_VLH 0x107f
#define MASK_VLH  0x707f
#define MATCH_VLXH 0x207f
#define MASK_VLXH  0x707f
#define MATCH_VLSH 0x307f
#define MASK_VLSH  0x707f
#define MATCH_VSH 0x507f
#define MASK_VSH  0x707f
#define MATCH_VSSH 0x607f
#define MASK_VSSH  0x707f
#define MATCH_VSXH 0x707f
#define MASK_VSXH  0x707f
...
DECLARE_INSN(vnot, MATCH_VNOT, MASK_VNOT)
DECLARE_INSN(vseq, MATCH_VSEQ, MASK_VSEQ)
DECLARE_INSN(vsneq, MATCH_VSNEQ, MASK_VSNEQ)
DECLARE_INSN(vslt, MATCH_VSLT, MASK_VSLT)
DECLARE_INSN(vsle, MATCH_VSLE, MASK_VSLE)
DECLARE_INSN(vsgt, MATCH_VSGT, MASK_VSGT)
DECLARE_INSN(vsge, MATCH_VSGE, MASK_VSGE)
DECLARE_INSN(vmove, MATCH_VMOVE, MASK_VMOVE)
DECLARE_INSN(vpermute, MATCH_VPERMUTE, MASK_VPERMUTE)
